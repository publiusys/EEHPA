...
fh = logging.FileHandler(f"ax-p99-pwr-server.log")
...
server_to_ip = {
    "server2.hand32-249889.bayopsys-pg0.wisc.cloudlab.us" : "192.168.1.2",
    "server3.hand32-249889.bayopsys-pg0.wisc.cloudlab.us" : "192.168.1.3",
    "server4.hand32-249889.bayopsys-pg0.wisc.cloudlab.us" : "192.168.1.4",
    "server5.hand32-249889.bayopsys-pg0.wisc.cloudlab.us" : "192.168.1.5",
    "server6.hand32-249889.bayopsys-pg0.wisc.cloudlab.us" : "192.168.1.6"
}
...
def getTotalPwr(uniqNodes):
    totPwr=0.0
    for n in uniqNodes:
        ret = runRemoteCommandGet(f"tail -n 20 ~/perf.log", server_to_ip[n])
        arrn = []
...
if __name__ == "__main__":
    ...
    for i in range(0, 1000):
        ...
        if float(numAllocs) > 132.0:
            ...
            logger.info(f"Nodes: {uniqNodes}, {len(uniqNodes)}")
        ax_client.save_to_json_file("ax-p99-pwr-server.json")
